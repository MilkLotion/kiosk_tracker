                ...
                if len(eyeROI) != 0 :
                    ...
                    if len(center_pos) != 0 :
                        if self.isSet is False:
                            ...
                            cv2.putText(img2, "see right_under", (50, 70), cv2.FONT_HERSHEY_COMPLEX, img2.shape[1] / 500,
                                        (0, 0, 255), 2)
                        else:
                            # 좌표에 따른 움직임 감지
                            sendmsg = self.iris_center_pos(center_pos)
                            cv2.putText(img2, str(sendmsg), (50, 70), cv2.FONT_HERSHEY_COMPLEX, img2.shape[1] / 500,
                                        (0, 0, 255), 2)
